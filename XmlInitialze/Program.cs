...
internal static class DataSource
{
    ...
    static void InitializeOrders()
    {
        ...
        XMLTools.SaveListToXMLSerializer(orders, "Orders");
        XMLTools.config.Element("orderID").Value = Config.orderId.ToString();
    }
    static void InitializeProducts()
    {
        ...
        XMLTools.SaveListToXMLSerializer(products, "Products");
    }
    static void InitialzieOrderItems()
    {
        ...
        XMLTools.SaveListToXMLSerializer(orderItems, "OrderItems");
        XMLTools.config.Element("orderItemID").Value = Config.orderItemId.ToString();
    }
